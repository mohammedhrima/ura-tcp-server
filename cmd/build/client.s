...
_log:                                   ; @log
Lfunc_begin0:
	.file	1 "ura-tcp-server/cmd" "client.ura"
...
_banner:                                ; @banner
Lfunc_begin7:
	.loc	1 3 0 is_stmt 1                 ; client.ura:3:0
	.cfi_startproc
; %bb.0:                                ; %entry
	stp	x29, x30, [sp, #-16]!           ; 16-byte Folded Spill
	.cfi_def_cfa_offset 16
...
Lloh31:
	...
	bl	_log
	.loc	1 14 0 epilogue_begin is_stmt 0 ; client.ura:14:0
	ldp	x29, x30, [sp], #16             ; 16-byte Folded Reload
	ret
Ltmp17:
...
Lfunc_begin8:
	.loc	1 21 0 is_stmt 1                ; client.ura:21:0
	.cfi_startproc
; %bb.0:                                ; %entry
	sub	sp, sp, #48
	stp	x20, x19, [sp, #16]             ; 16-byte Folded Spill
	...
	mov	x19, x0
Ltmp18:
	.loc	1 21 0 prologue_end             ; client.ura:21:0
	str	x0, [sp, #8]
	.loc	1 22 0                          ; client.ura:22:0
	mov	w0, #2                          ; =0x2
	mov	w1, #1                          ; =0x1
...
LBB8_2:                                 ; %if.end
	...
	bl	_calloc
	str	x0, [x20, #16]
	.loc	1 25 0 epilogue_begin is_stmt 0 ; client.ura:25:0
	ldp	x29, x30, [sp, #32]             ; 16-byte Folded Reload
	ldp	x20, x19, [sp, #16]             ; 16-byte Folded Reload
	add	sp, sp, #48
	ret
...
Lfunc_begin9:
	.loc	1 29 0 is_stmt 1                ; client.ura:29:0
	.cfi_startproc
; %bb.0:                                ; %entry
	sub	sp, sp, #32
	stp	x29, x30, [sp, #16]             ; 16-byte Folded Spill
	...
	.cfi_offset w29, -16
Ltmp20:
	.loc	1 30 0 prologue_end             ; client.ura:30:0
	ldr	w8, [x0]
	...
	ldr	x0, [x8, #16]
	bl	_free
	.loc	1 32 0 epilogue_begin is_stmt 0 ; client.ura:32:0
	ldp	x29, x30, [sp, #16]             ; 16-byte Folded Reload
	add	sp, sp, #32
	ret
Ltmp21:
...
_main:                                  ; @main
Lfunc_begin10:
	.loc	1 34 0 is_stmt 1                ; client.ura:34:0
	.cfi_startproc
; %bb.0:                                ; %entry
	sub	sp, sp, #96
	...
	.cfi_offset w22, -48
Ltmp22:
	.loc	1 35 0 prologue_end             ; client.ura:35:0
	bl	_banner
	add	x0, sp, #40
	str	xzr, [sp, #40]
	bl	_SockAddr.init
...
Lloh42:
	adrp	x19, l_STR31@PAGE
Lloh43:
	add	x19, x19, l_STR31@PAGEOFF
Lloh44:
	adrp	x20, l_STR32@PAGE
Lloh45:
	add	x20, x20, l_STR32@PAGEOFF
LBB10_3:                                ; %while.start18
                                        ; =>This Inner Loop Header: Depth=1
	bl	_log
	.loc	1 67 0 is_stmt 1                ; client.ura:67:0
	ldr	x1, [sp, #24]
	mov	w0, wzr
	mov	w2, #1023                       ; =0x3ff
	bl	_read
...
; %bb.4:                                ; %if.end24
	...
	cbnz	w8, LBB10_3
LBB10_5:                                ; %while.end20
	.loc	1 79 0                          ; client.ura:79:0
	add	x0, sp, #16
	bl	_Client.clean
	.loc	1 80 0                          ; client.ura:80:0
	add	x0, sp, #40
	bl	_SockAddr.clean
	add	x0, sp, #40
	bl	_SockAddr.clean
	...
	b	LBB10_11
LBB10_6:                                ; %if.then
	.loc	1 44 0                          ; client.ura:44:0
Lloh46:
	adrp	x0, l_STR17@PAGE
Lloh47:
	add	x0, x0, l_STR17@PAGEOFF
Lloh48:
	adrp	x1, l_STR18@PAGE
Lloh49:
	add	x1, x1, l_STR18@PAGEOFF
Lloh50:
	adrp	x2, l_STR19@PAGE
Lloh51:
	add	x2, x2, l_STR19@PAGEOFF
	bl	_log_ts
	mov	w0, #1                          ; =0x1
	b	LBB10_12
LBB10_7:
...
Lloh56:
	adrp	x21, l_STR28@PAGE
Lloh57:
	add	x21, x21, l_STR28@PAGEOFF
Lloh58:
	adrp	x22, l_STR29@PAGE
Lloh59:
	add	x22, x22, l_STR29@PAGEOFF
LBB10_8:                                ; %while.then
                                        ; =>This Inner Loop Header: Depth=1
	.loc	1 54 0 is_stmt 1                ; client.ura:54:0
	ldr	w0, [sp, #16]
	ldr	x1, [sp, #32]
	mov	w2, #1023                       ; =0x3ff
	bl	_read
...
l_STR14:                                ; @STR14
	.asciz	"\033[0;36m  URA Chat Client  \033[0;90m\342\224\202\033[0m connecting to \033[0;33m127.0.0.1:17000\033[0m\n"
...
Linfo_string:
	...
	.asciz	"Client.init"                   ; string offset=124
	.asciz	"Client.clean"                  ; string offset=136
...
Lnames_begin:
	...
	.long	-1                              ; Bucket 9
	.long	-1                              ; Bucket 10
	.long	-208531877                      ; Hash in Bucket 0
	.long	-1447155514                     ; Hash in Bucket 2
	.long	-1576193774                     ; Hash in Bucket 3
	.long	-25636205                       ; Hash in Bucket 3
	.long	193498375                       ; Hash in Bucket 4
	.long	-518683979                      ; Hash in Bucket 4
	.long	-155867602                      ; Hash in Bucket 4
	.long	1892955170                      ; Hash in Bucket 7
	.long	2090499946                      ; Hash in Bucket 7
	.long	199157549                       ; Hash in Bucket 8
	.long	-481979263                      ; Hash in Bucket 8
.set Lset15, LNames7-Lnames_begin       ; Offset in Bucket 0
	.long	Lset15
.set Lset16, LNames8-Lnames_begin       ; Offset in Bucket 2
	.long	Lset16
.set Lset17, LNames3-Lnames_begin       ; Offset in Bucket 3
	.long	Lset17
.set Lset18, LNames1-Lnames_begin       ; Offset in Bucket 3
	.long	Lset18
.set Lset19, LNames0-Lnames_begin       ; Offset in Bucket 4
	.long	Lset19
.set Lset20, LNames9-Lnames_begin       ; Offset in Bucket 4
	.long	Lset20
.set Lset21, LNames4-Lnames_begin       ; Offset in Bucket 4
	.long	Lset21
.set Lset22, LNames5-Lnames_begin       ; Offset in Bucket 7
	.long	Lset22
.set Lset23, LNames10-Lnames_begin      ; Offset in Bucket 7
	.long	Lset23
.set Lset24, LNames2-Lnames_begin       ; Offset in Bucket 8
	.long	Lset24
.set Lset25, LNames6-Lnames_begin       ; Offset in Bucket 8
	.long	Lset25
LNames7:
	.long	117                             ; banner
	.long	1                               ; Num DIEs
