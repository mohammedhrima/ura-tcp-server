; ModuleID = '/ura-lang/src/tests/projects/ura-tcp-server/basic/build/client.prep.ura'
source_filename = "/ura-lang/src/tests/projects/ura-tcp-server/basic/build/client.prep.ura"
...
define void @banner(i8* %host, i32 %port) !dbg !76 {
entry:
  %host1 = alloca i8*, align 8, !dbg !77
  %port2 = alloca i32, align 4, !dbg !77
  store i8* %host, i8** %host1, align 8, !dbg !77
  store i32 %port, i32* %port2, align 4, !dbg !77
  call void @log(i8* getelementptr inbounds ([8 x i8], [8 x i8]* @STR6, i32 0, i32 0)), !dbg !78
  call void @log(i8* getelementptr inbounds ([123 x i8], [123 x i8]* @STR7, i32 0, i32 0)), !dbg !79
  call void @log(i8* getelementptr inbounds ([127 x i8], [127 x i8]* @STR8, i32 0, i32 0)), !dbg !80
  call void @log(i8* getelementptr inbounds ([103 x i8], [103 x i8]* @STR9, i32 0, i32 0)), !dbg !81
  call void @log(i8* getelementptr inbounds ([105 x i8], [105 x i8]* @STR10, i32 0, i32 0)), !dbg !82
  call void @log(i8* getelementptr inbounds ([127 x i8], [127 x i8]* @STR11, i32 0, i32 0)), !dbg !83
  call void @log(i8* getelementptr inbounds ([123 x i8], [123 x i8]* @STR12, i32 0, i32 0)), !dbg !84
  call void @log(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @STR13, i32 0, i32 0)), !dbg !85
  call void @log(i8* getelementptr inbounds ([148 x i8], [148 x i8]* @STR14, i32 0, i32 0)), !dbg !86
  %host3 = load i8*, i8** %host1, align 8, !dbg !86
  %port4 = load i32, i32* %port2, align 4, !dbg !86
  %0 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([73 x i8], [73 x i8]* @output_fmt, i32 0, i32 0), i8* %host3, i32 %port4), !dbg !86
  call void @log(i8* getelementptr inbounds ([149 x i8], [149 x i8]* @STR18, i32 0, i32 0)), !dbg !87
  ret void, !dbg !87
}

define i32 @main() !dbg !88 {
entry:
  %host = alloca i8*, align 8, !dbg !89
  %port = alloca i32, align 4, !dbg !89
  %addr = alloca %struct.SockAddr, align 8, !dbg !89
  %cli = alloca %struct.Client, align 8, !dbg !89
  %result = alloca i32, align 4, !dbg !89
  %r = alloca i32, align 4, !dbg !89
  %pid = alloca i32, align 4, !dbg !89
  store i8* null, i8** %host, align 8, !dbg !89
  store i8* getelementptr inbounds ([10 x i8], [10 x i8]* @STR19, i32 0, i32 0), i8** %host, align 8, !dbg !89
  store i32 0, i32* %port, align 4, !dbg !89
  store i32 17000, i32* %port, align 4, !dbg !89
  %host1 = load i8*, i8** %host, align 8, !dbg !90
  %port2 = load i32, i32* %port, align 4, !dbg !90
  call void @banner(i8* %host1, i32 %port2), !dbg !90
  store %struct.SockAddr zeroinitializer, %struct.SockAddr* %addr, align 8, !dbg !89
  %ref_arg = load %struct.SockAddr*, %struct.SockAddr* %addr, align 8, !dbg !91
  %port3 = load i32, i32* %port, align 4, !dbg !91
  call void @SockAddr_set_port(%struct.SockAddr* %ref_arg, i32 %port3), !dbg !91
  %ref_arg4 = load %struct.SockAddr*, %struct.SockAddr* %addr, align 8, !dbg !92
  call void @SockAddr_set_ip(%struct.SockAddr* %ref_arg4, i32 127, i32 0, i32 0, i32 1), !dbg !92
  store %struct.Client zeroinitializer, %struct.Client* %cli, align 8, !dbg !89
  br label %if.start, !dbg !89

if.start:                                         ; preds = %entry
  %fd = getelementptr %struct.Client, %struct.Client* %cli, i32 0, i32 0, !dbg !89
  %DOT = load i32, i32* %fd, align 4, !dbg !89
  %LT = icmp slt i32 %DOT, 0, !dbg !89
  br i1 %LT, label %if.then, label %if.end, !dbg !89

if.end:                                           ; preds = %if.start
  store i32 0, i32* %result, align 4, !dbg !89
  %fd5 = getelementptr %struct.Client, %struct.Client* %cli, i32 0, i32 0, !dbg !93
  %DOT6 = load i32, i32* %fd5, align 4, !dbg !93
  %data = getelementptr %struct.SockAddr, %struct.SockAddr* %addr, i32 0, i32 0, !dbg !93
  %DOT7 = load i8*, i8** %data, align 8, !dbg !93
  %connect = call i32 @connect(i32 %DOT6, i8* %DOT7, i32 16), !dbg !93
  store i32 %connect, i32* %result, align 4, !dbg !93
  br label %if.start8, !dbg !93

if.then:                                          ; preds = %if.start
  call void @log_ts(i8* getelementptr inbounds ([8 x i8], [8 x i8]* @STR20, i32 0, i32 0), i8* getelementptr inbounds ([9 x i8], [9 x i8]* @STR21, i32 0, i32 0), i8* getelementptr inbounds ([14 x i8], [14 x i8]* @STR22, i32 0, i32 0)), !dbg !94
  ret i32 1, !dbg !94

if.start8:                                        ; preds = %if.end
  %result11 = load i32, i32* %result, align 4, !dbg !93
  %LT12 = icmp slt i32 %result11, 0, !dbg !93
  br i1 %LT12, label %if.then10, label %if.end9, !dbg !93

if.end9:                                          ; preds = %if.start8
  call void @log_ts(i8* getelementptr inbounds ([8 x i8], [8 x i8]* @STR26, i32 0, i32 0), i8* getelementptr inbounds ([9 x i8], [9 x i8]* @STR27, i32 0, i32 0), i8* getelementptr inbounds ([20 x i8], [20 x i8]* @STR28, i32 0, i32 0)), !dbg !95
  store i32 0, i32* %r, align 4, !dbg !89
  store i32 0, i32* %r, align 4, !dbg !89
  store i32 0, i32* %pid, align 4, !dbg !89
  %fork = call i32 @fork(), !dbg !96
  store i32 %fork, i32* %pid, align 4, !dbg !96
  br label %if.start13, !dbg !96

if.then10:                                        ; preds = %if.start8
  call void @log_ts(i8* getelementptr inbounds ([8 x i8], [8 x i8]* @STR23, i32 0, i32 0), i8* getelementptr inbounds ([9 x i8], [9 x i8]* @STR24, i32 0, i32 0), i8* getelementptr inbounds ([15 x i8], [15 x i8]* @STR25, i32 0, i32 0)), !dbg !97
  ret i32 1, !dbg !97

if.start13:                                       ; preds = %if.end9
  %pid16 = load i32, i32* %pid, align 4, !dbg !96
  %EQ = icmp eq i32 %pid16, 0, !dbg !96
  br i1 %EQ, label %if.then15, label %if.end14, !dbg !96

if.end14:                                         ; preds = %if.start13
  call void @log(i8* getelementptr inbounds ([23 x i8], [23 x i8]* @STR36, i32 0, i32 0)), !dbg !98
  br label %while.start29, !dbg !98

if.then15:                                        ; preds = %if.start13
  br label %while.start, !dbg !96

while.start:                                      ; preds = %if.end21, %if.then15
  br i1 true, label %while.then, label %while.end, !dbg !96

while.then:                                       ; preds = %while.start
  %fd17 = getelementptr %struct.Client, %struct.Client* %cli, i32 0, i32 0, !dbg !99
  %DOT18 = load i32, i32* %fd17, align 4, !dbg !99
  %rbuf = getelementptr %struct.Client, %struct.Client* %cli, i32 0, i32 2, !dbg !99
  %DOT19 = load i8*, i8** %rbuf, align 8, !dbg !99
  %read = call i32 @read(i32 %DOT18, i8* %DOT19, i32 1023), !dbg !99
  store i32 %read, i32* %r, align 4, !dbg !99
  br label %if.start20, !dbg !99

while.end:                                        ; preds = %if.then22, %while.start
  ret i32 0, !dbg !100

if.start20:                                       ; preds = %while.then
  %r23 = load i32, i32* %r, align 4, !dbg !99
  %LE = icmp sle i32 %r23, 0, !dbg !99
  br i1 %LE, label %if.then22, label %if.end21, !dbg !99

if.end21:                                         ; preds = %if.start20
  %rbuf24 = getelementptr %struct.Client, %struct.Client* %cli, i32 0, i32 2, !dbg !101
  %DOT25 = load i8*, i8** %rbuf24, align 8, !dbg !101
  %r26 = load i32, i32* %r, align 4, !dbg !101
  %ACCESS = getelementptr i8, i8* %DOT25, i32 %r26, !dbg !101
  store i8 0, i8* %ACCESS, align 1, !dbg !101
  call void @log(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @STR32, i32 0, i32 0)), !dbg !102
  %rbuf27 = getelementptr %struct.Client, %struct.Client* %cli, i32 0, i32 2, !dbg !103
  %DOT28 = load i8*, i8** %rbuf27, align 8, !dbg !103
  call void @log_ts(i8* getelementptr inbounds ([8 x i8], [8 x i8]* @STR33, i32 0, i32 0), i8* getelementptr inbounds ([9 x i8], [9 x i8]* @STR34, i32 0, i32 0), i8* %DOT28), !dbg !103
  call void @log(i8* getelementptr inbounds ([23 x i8], [23 x i8]* @STR35, i32 0, i32 0)), !dbg !100
  br label %while.start, !dbg !100

if.then22:                                        ; preds = %if.start20
  call void @log_ts(i8* getelementptr inbounds ([8 x i8], [8 x i8]* @STR29, i32 0, i32 0), i8* getelementptr inbounds ([9 x i8], [9 x i8]* @STR30, i32 0, i32 0), i8* getelementptr inbounds ([20 x i8], [20 x i8]* @STR31, i32 0, i32 0)), !dbg !104
  br label %while.end, !dbg !104

while.start29:                                    ; preds = %if.end35, %if.end14
  br i1 true, label %while.then30, label %while.end31, !dbg !98

while.then30:                                     ; preds = %while.start29
  %buf = getelementptr %struct.Client, %struct.Client* %cli, i32 0, i32 1, !dbg !105
  %DOT32 = load i8*, i8** %buf, align 8, !dbg !105
  %read33 = call i32 @read(i32 0, i8* %DOT32, i32 1023), !dbg !105
  store i32 %read33, i32* %r, align 4, !dbg !105
  br label %if.start34, !dbg !105

while.end31:                                      ; preds = %if.then36, %while.start29
  %fd49 = getelementptr %struct.Client, %struct.Client* %cli, i32 0, i32 0, !dbg !106
  %DOT50 = load i32, i32* %fd49, align 4, !dbg !106
  %close = call i32 @close(i32 %DOT50), !dbg !106
  %ref_arg51 = load %struct.SockAddr*, %struct.SockAddr* %addr, align 8, !dbg !107
  call void @SockAddr_delete(%struct.SockAddr* %ref_arg51), !dbg !107
  call void @SockAddr.delete(%struct.SockAddr* %addr), !dbg !107
  call void @Client.delete(%struct.Client* %cli), !dbg !107
  ret i32 0, !dbg !107

if.start34:                                       ; preds = %while.then30
  %r37 = load i32, i32* %r, align 4, !dbg !105
  %LE38 = icmp sle i32 %r37, 0, !dbg !105
  br i1 %LE38, label %if.then36, label %if.end35, !dbg !105

if.end35:                                         ; preds = %if.start34
  %buf39 = getelementptr %struct.Client, %struct.Client* %cli, i32 0, i32 1, !dbg !108
  %r40 = load i32, i32* %r, align 4, !dbg !108
  %SUB = sub i32 %r40, 1, !dbg !108
  %DOT41 = load i8*, i8** %buf39, align 8, !dbg !108
  %ACCESS42 = getelementptr i8, i8* %DOT41, i32 %SUB, !dbg !108
  store i8 0, i8* %ACCESS42, align 1, !dbg !108
  %fd43 = getelementptr %struct.Client, %struct.Client* %cli, i32 0, i32 0, !dbg !109
  %DOT44 = load i32, i32* %fd43, align 4, !dbg !109
  %buf45 = getelementptr %struct.Client, %struct.Client* %cli, i32 0, i32 1, !dbg !109
  %DOT46 = load i8*, i8** %buf45, align 8, !dbg !109
  %r47 = load i32, i32* %r, align 4, !dbg !109
  %SUB48 = sub i32 %r47, 1, !dbg !109
  %write = call i32 @write(i32 %DOT44, i8* %DOT46, i32 %SUB48), !dbg !109
  call void @log(i8* getelementptr inbounds ([23 x i8], [23 x i8]* @STR37, i32 0, i32 0)), !dbg !110
  br label %while.start29, !dbg !110

if.then36:                                        ; preds = %if.start34
  br label %while.end31, !dbg !105
}
...
!3 = !DIFile(filename: "client.prep.ura", directory: "/ura-lang/src/tests/projects/ura-tcp-server/basic/build")
...
!88 = distinct !DISubprogram(name: "main", linkageName: "main", scope: null, file: !3, line: 939, type: !5, scopeLine: 939, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !6)
!89 = !DILocation(line: 939, scope: !88)
!90 = !DILocation(line: 942, scope: !88)
!91 = !DILocation(line: 944, scope: !88)
!92 = !DILocation(line: 945, scope: !88)
!93 = !DILocation(line: 950, scope: !88)
!94 = !DILocation(line: 948, scope: !88)
!95 = !DILocation(line: 954, scope: !88)
!96 = !DILocation(line: 956, scope: !88)
!97 = !DILocation(line: 952, scope: !88)
!98 = !DILocation(line: 968, scope: !88)
!99 = !DILocation(line: 959, scope: !88)
!100 = !DILocation(line: 966, scope: !88)
!101 = !DILocation(line: 963, scope: !88)
!102 = !DILocation(line: 964, scope: !88)
!103 = !DILocation(line: 965, scope: !88)
!104 = !DILocation(line: 961, scope: !88)
!105 = !DILocation(line: 970, scope: !88)
!106 = !DILocation(line: 976, scope: !88)
!107 = !DILocation(line: 977, scope: !88)
!108 = !DILocation(line: 973, scope: !88)
!109 = !DILocation(line: 974, scope: !88)
!110 = !DILocation(line: 975, scope: !88)
