...
_log:                                   ; @log
Lfunc_begin0:
	.file	1 "ura-tcp-server/basic" "server.ura"
...
_banner:                                ; @banner
Lfunc_begin7:
	.loc	1 4 0 is_stmt 1                 ; server.ura:4:0
	.cfi_startproc
; %bb.0:                                ; %entry
	sub	sp, sp, #32
	stp	x29, x30, [sp, #16]             ; 16-byte Folded Spill
...
Lloh31:
	...
	bl	_log
	.loc	1 15 0 epilogue_begin is_stmt 0 ; server.ura:15:0
	ldp	x29, x30, [sp, #16]             ; 16-byte Folded Reload
	add	sp, sp, #32
	ret
Ltmp17:
...
Lfunc_begin9:
	.loc	1 23 0 is_stmt 1                ; server.ura:23:0
	.cfi_startproc
; %bb.0:                                ; %entry
	sub	sp, sp, #48
	stp	x20, x19, [sp, #16]             ; 16-byte Folded Spill
	...
	mov	x19, x0
Ltmp18:
	.loc	1 23 0 prologue_end             ; server.ura:23:0
	str	x0, [sp, #8]
	.loc	1 24 0                          ; server.ura:24:0
	mov	w0, #2                          ; =0x2
	mov	w1, #1                          ; =0x1
	mov	w2, wzr
	bl	_socket
...
LBB9_2:                                 ; %if.end
	...
	ldr	x0, [x8, #16]
	bl	_bzero
	.loc	1 32 0 epilogue_begin is_stmt 0 ; server.ura:32:0
	ldp	x29, x30, [sp, #32]             ; 16-byte Folded Reload
	ldp	x20, x19, [sp, #16]             ; 16-byte Folded Reload
	add	sp, sp, #48
	ret
...
Lfunc_begin10:
	.loc	1 34 0 is_stmt 1                ; server.ura:34:0
	.cfi_startproc
; %bb.0:                                ; %entry
	sub	sp, sp, #48
	stp	x29, x30, [sp, #32]             ; 16-byte Folded Spill
	...
	mov	w8, #1                          ; =0x1
Ltmp20:
	.loc	1 34 0 prologue_end             ; server.ura:34:0
	str	x0, [sp, #24]
	.loc	1 37 0                          ; server.ura:37:0
	add	x3, sp, #12
	...
	ldr	w0, [x8]
	bl	_setsockopt
	.loc	1 38 0 epilogue_begin is_stmt 0 ; server.ura:38:0
	ldp	x29, x30, [sp, #32]             ; 16-byte Folded Reload
	add	sp, sp, #48
	ret
Ltmp21:
...
Ltmp22:
	...
	str	w0, [sp]
	cbz	w0, LBB11_5
; %bb.1:                                ; %while.start17.preheader
	.loc	1 0 0 is_stmt 0                 ; server.ura:0:0
Lloh34:
	adrp	x0, l_STR25@PAGE
Lloh35:
	add	x0, x0, l_STR25@PAGEOFF
Lloh36:
	adrp	x19, l_STR26@PAGE
Lloh37:
	add	x19, x19, l_STR26@PAGEOFF
LBB11_2:                                ; %while.start17
                                        ; =>This Inner Loop Header: Depth=1
	bl	_log
	.loc	1 57 0 is_stmt 1                ; server.ura:57:0
	ldr	x8, [sp, #8]
	mov	w0, wzr
	mov	w2, #1023                       ; =0x3ff
	ldr	x1, [x8, #16]
...
; %bb.3:                                ; %if.end24
	...
	.loc	1 60 0 is_stmt 1                ; server.ura:60:0
	ldr	w9, [sp, #4]
	ldr	x8, [x8, #16]
	sub	w2, w9, #1
	.loc	1 61 0                          ; server.ura:61:0
	ldr	x9, [sp, #8]
	.loc	1 60 0                          ; server.ura:60:0
	strb	wzr, [x8, w2, sxtw]
	.loc	1 61 0                          ; server.ura:61:0
	ldr	w0, [x9, #4]
	ldr	x1, [x9, #16]
	...
	b	LBB11_2
LBB11_4:                                ; %if.then25
	.loc	1 64 0                          ; server.ura:64:0
	ldr	w0, [x8, #4]
	bl	_close
	b	LBB11_9
LBB11_5:                                ; %while.then.preheader
	.loc	1 0 0 is_stmt 0                 ; server.ura:0:0
Lloh38:
...
LBB11_6:                                ; %while.then
                                        ; =>This Inner Loop Header: Depth=1
	.loc	1 45 0 is_stmt 1                ; server.ura:45:0
	ldr	x8, [sp, #8]
	mov	w2, #1023                       ; =0x3ff
	ldr	w0, [x8, #4]
	ldr	x1, [x8, #8]
...
_main:                                  ; @main
Lfunc_begin12:
	.loc	1 66 0 is_stmt 1                ; server.ura:66:0
	.cfi_startproc
; %bb.0:                                ; %entry
	sub	sp, sp, #96
	...
	mov	w8, #17000                      ; =0x4268
Ltmp24:
	.loc	1 68 0 prologue_end             ; server.ura:68:0
	mov	w0, #17000                      ; =0x4268
	.loc	1 66 0                          ; server.ura:66:0
	str	w8, [sp, #44]
	.loc	1 68 0                          ; server.ura:68:0
	bl	_banner
	.loc	1 66 0                          ; server.ura:66:0
	add	x0, sp, #32
	str	xzr, [sp, #32]
	...
	tbnz	w0, #31, LBB12_6
; %bb.1:                                ; %if.end
	.loc	1 82 0                          ; server.ura:82:0
	ldr	w0, [sp, #8]
	mov	w1, #5                          ; =0x5
	bl	_listen
	.loc	1 83 0                          ; server.ura:83:0
Lloh52:
	adrp	x0, l_STR30@PAGE
Lloh53:
	add	x0, x0, l_STR30@PAGEOFF
Lloh54:
	adrp	x1, l_STR31@PAGE
Lloh55:
	add	x1, x1, l_STR31@PAGEOFF
Lloh56:
	adrp	x2, l_STR32@PAGE
Lloh57:
	add	x2, x2, l_STR32@PAGEOFF
	bl	_log_ts
Lloh58:
...
Lloh60:
	adrp	x20, l_STR34@PAGE
Lloh61:
	add	x20, x20, l_STR34@PAGEOFF
Lloh62:
	adrp	x21, l_STR35@PAGE
Lloh63:
	add	x21, x21, l_STR35@PAGEOFF
LBB12_2:                                ; %while.then
                                        ; =>This Inner Loop Header: Depth=1
	.loc	1 86 0                          ; server.ura:86:0
	ldr	w0, [sp, #8]
	mov	x1, xzr
	mov	x2, xzr
	bl	_accept
...
LBB12_5:                                ; %if.then17
	...
	b	LBB12_7
LBB12_6:                                ; %if.then
	.loc	1 79 0                          ; server.ura:79:0
Lloh64:
	adrp	x0, l_STR27@PAGE
Lloh65:
	add	x0, x0, l_STR27@PAGEOFF
Lloh66:
	adrp	x1, l_STR28@PAGE
Lloh67:
	add	x1, x1, l_STR28@PAGEOFF
Lloh68:
	adrp	x2, l_STR29@PAGE
Lloh69:
	add	x2, x2, l_STR29@PAGEOFF
	bl	_log_ts
	mov	w0, #1                          ; =0x1
LBB12_7:                                ; %common.ret
	.loc	1 0 0 epilogue_begin is_stmt 0  ; server.ura:0:0
...
l_STR14:                                ; @STR14
	.asciz	"\033[0;32m  URA Chat Server  \033[0;90m\342\224\202\033[0m port \033[0;33m"

l_STR15:                                ; @STR15
	.asciz	"\033[0m\n"

l_output_fmt:                           ; @output_fmt
	.asciz	"\033[0;32m  URA Chat Server  \033[0;90m\342\224\202\033[0m port \033[0;33m%d\033[0m\n"
...
.set Lset1, Lsection_abbrev-Lsection_abbrev ; Offset Into Abbrev. Section
	...
	.byte	1                               ; Abbrev [1] 0xb:0x14c DW_TAG_compile_unit
...
.set Lset15, Lfunc_end12-Lfunc_begin12  ; DW_AT_high_pc
	.long	Lset15
                                        ; DW_AT_APPLE_omit_frame_ptr
	.byte	1                               ; DW_AT_frame_base
	.byte	111
	.long	176                             ; DW_AT_linkage_name
	.long	176                             ; DW_AT_name
	.byte	1                               ; DW_AT_decl_file
...
Linfo_string:
	...
	.asciz	"Server.init"                   ; string offset=126
	.asciz	"Server.set_reuse"              ; string offset=138
	.asciz	"Server.handle_client"          ; string offset=155
...
Lnames_begin:
	...
	.long	9                               ; Bucket 10
	.long	10                              ; Bucket 11
	.long	103860468                       ; Hash in Bucket 0
	.long	1892955170                      ; Hash in Bucket 2
	.long	-1576193774                     ; Hash in Bucket 2
	.long	-225956642                      ; Hash in Bucket 2
	.long	199157549                       ; Hash in Bucket 5
	.long	-722114183                      ; Hash in Bucket 5
	.long	-155867602                      ; Hash in Bucket 6
	.long	193498375                       ; Hash in Bucket 7
	.long	-481979263                      ; Hash in Bucket 9
	.long	2090499946                      ; Hash in Bucket 10
	.long	-208531877                      ; Hash in Bucket 11
	.long	-25636205                       ; Hash in Bucket 11
.set Lset16, LNames10-Lnames_begin      ; Offset in Bucket 0
	.long	Lset16
.set Lset17, LNames5-Lnames_begin       ; Offset in Bucket 2
	.long	Lset17
.set Lset18, LNames3-Lnames_begin       ; Offset in Bucket 2
	.long	Lset18
.set Lset19, LNames8-Lnames_begin       ; Offset in Bucket 2
	.long	Lset19
.set Lset20, LNames2-Lnames_begin       ; Offset in Bucket 5
	.long	Lset20
.set Lset21, LNames9-Lnames_begin       ; Offset in Bucket 5
	.long	Lset21
.set Lset22, LNames4-Lnames_begin       ; Offset in Bucket 6
	.long	Lset22
.set Lset23, LNames0-Lnames_begin       ; Offset in Bucket 7
	.long	Lset23
.set Lset24, LNames6-Lnames_begin       ; Offset in Bucket 9
	.long	Lset24
.set Lset25, LNames11-Lnames_begin      ; Offset in Bucket 10
	.long	Lset25
.set Lset26, LNames7-Lnames_begin       ; Offset in Bucket 11
	.long	Lset26
.set Lset27, LNames1-Lnames_begin       ; Offset in Bucket 11
	.long	Lset27
LNames10:
	.long	155                             ; Server.handle_client
	.long	1                               ; Num DIEs
	.long	292
	.long	0
LNames5:
