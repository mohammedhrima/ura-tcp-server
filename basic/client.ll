...
@STR15 = private unnamed_addr constant [63 x i8] c"\1B[0;36m  URA Chat Client  \1B[0;90m\E2\94\82\1B[0m connecting to \1B[0;33m\00", align 1
@STR16 = private unnamed_addr constant [2 x i8] c":\00", align 1
@STR17 = private unnamed_addr constant [6 x i8] c"\1B[0m\0A\00", align 1
...
@STR18 = private unnamed_addr constant [149 x i8] c"\1B[0;90m\E2\94\80\E2\94\80\E2\94\80\E2\94\80\E2\94\80\E2\94\80\E2\94\80\E2\94\80\E2\94\80\E2\94\80\E2\94\80\E2\94\80\E2\94\80\E2\94\80\E2\94\80\E2\94\80\E2\94\80\E2\94\80\E2\94\80\E2\94\80\E2\94\80\E2\94\80\E2\94\80\E2\94\80\E2\94\80\E2\94\80\E2\94\80\E2\94\80\E2\94\80\E2\94\80\E2\94\80\E2\94\80\E2\94\80\E2\94\80\E2\94\80\E2\94\80\E2\94\80\E2\94\80\E2\94\80\E2\94\80\E2\94\80\E2\94\80\E2\94\80\E2\94\80\E2\94\80\1B[0m\0A\0A\00", align 1
@STR19 = private unnamed_addr constant [32 x i8] c"failed to create client socket\0A\00", align 1
...
define void @banner(i8* %host, i32 %port) !dbg !197 {
entry:
  %host1 = alloca i8*, align 8, !dbg !198
  %port2 = alloca i32, align 4, !dbg !198
  store i8* %host, i8** %host1, align 8, !dbg !198
  store i32 %port, i32* %port2, align 4, !dbg !198
  call void @log(i8* getelementptr inbounds ([8 x i8], [8 x i8]* @STR6, i32 0, i32 0)), !dbg !199
  call void @log(i8* getelementptr inbounds ([123 x i8], [123 x i8]* @STR7, i32 0, i32 0)), !dbg !200
  call void @log(i8* getelementptr inbounds ([127 x i8], [127 x i8]* @STR8, i32 0, i32 0)), !dbg !201
  call void @log(i8* getelementptr inbounds ([103 x i8], [103 x i8]* @STR9, i32 0, i32 0)), !dbg !202
  call void @log(i8* getelementptr inbounds ([105 x i8], [105 x i8]* @STR10, i32 0, i32 0)), !dbg !203
  call void @log(i8* getelementptr inbounds ([127 x i8], [127 x i8]* @STR11, i32 0, i32 0)), !dbg !204
  call void @log(i8* getelementptr inbounds ([123 x i8], [123 x i8]* @STR12, i32 0, i32 0)), !dbg !205
  call void @log(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @STR13, i32 0, i32 0)), !dbg !206
  call void @log(i8* getelementptr inbounds ([148 x i8], [148 x i8]* @STR14, i32 0, i32 0)), !dbg !207
  %host3 = load i8*, i8** %host1, align 8, !dbg !207
  %port4 = load i32, i32* %port2, align 4, !dbg !207
  %0 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([73 x i8], [73 x i8]* @output_fmt, i32 0, i32 0), i32 2, i8* %host3, i32 %port4), !dbg !207
  call void @log(i8* getelementptr inbounds ([149 x i8], [149 x i8]* @STR18, i32 0, i32 0)), !dbg !208
  ret void, !dbg !208
}
...
if.end:                                           ; preds = %if.then, %if.start
  ...
  %self8 = load %struct.Client*, %struct.Client** %self1, align 8, !dbg !213
  %buf9 = getelementptr %struct.Client, %struct.Client* %self8, i32 0, i32 1, !dbg !213
  %DOT10 = load i8*, i8** %buf9, align 8, !dbg !213
  call void @bzero(i8* %DOT10, i64 1024), !dbg !213
  %self11 = load %struct.Client*, %struct.Client** %self1, align 8, !dbg !214
  %rbuf12 = getelementptr %struct.Client, %struct.Client* %self11, i32 0, i32 2, !dbg !214
  %DOT13 = load i8*, i8** %rbuf12, align 8, !dbg !214
  call void @bzero(i8* %DOT13, i64 1024), !dbg !214
  ret void, !dbg !214

if.then:                                          ; preds = %if.start
  call void @log(i8* getelementptr inbounds ([32 x i8], [32 x i8]* @STR19, i32 0, i32 0)), !dbg !215
...
!213 = !DILocation(line: 29, scope: !209)
!214 = !DILocation(line: 30, scope: !209)
!215 = !DILocation(line: 25, scope: !209)
