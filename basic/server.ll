...
@STR18 = private unnamed_addr constant [32 x i8] c"failed to create server socket\0A\00", align 1
...
@STR22 = private unnamed_addr constant [6 x i8] c"\0D\1B[2K\00", align 1
@STR23 = private unnamed_addr constant [8 x i8] c"\1B[0;36m\00", align 1
...
@STR27 = private unnamed_addr constant [23 x i8] c"\1B[0;32m[server]\1B[0m > \00", align 1
...
define void @banner(i32 %port) !dbg !197 {
entry:
  %port1 = alloca i32, align 4, !dbg !198
  store i32 %port, i32* %port1, align 4, !dbg !198
  call void @log(i8* getelementptr inbounds ([8 x i8], [8 x i8]* @STR6, i32 0, i32 0)), !dbg !199
  call void @log(i8* getelementptr inbounds ([92 x i8], [92 x i8]* @STR7, i32 0, i32 0)), !dbg !200
  call void @log(i8* getelementptr inbounds ([98 x i8], [98 x i8]* @STR8, i32 0, i32 0)), !dbg !201
  call void @log(i8* getelementptr inbounds ([80 x i8], [80 x i8]* @STR9, i32 0, i32 0)), !dbg !202
  call void @log(i8* getelementptr inbounds ([80 x i8], [80 x i8]* @STR10, i32 0, i32 0)), !dbg !203
  call void @log(i8* getelementptr inbounds ([82 x i8], [82 x i8]* @STR11, i32 0, i32 0)), !dbg !204
  call void @log(i8* getelementptr inbounds ([80 x i8], [80 x i8]* @STR12, i32 0, i32 0)), !dbg !205
  call void @log(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @STR13, i32 0, i32 0)), !dbg !206
  call void @log(i8* getelementptr inbounds ([112 x i8], [112 x i8]* @STR14, i32 0, i32 0)), !dbg !207
  %port2 = load i32, i32* %port1, align 4, !dbg !207
  %0 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([61 x i8], [61 x i8]* @output_fmt, i32 0, i32 0), i32 1, i32 %port2), !dbg !207
  call void @log(i8* getelementptr inbounds ([113 x i8], [113 x i8]* @STR17, i32 0, i32 0)), !dbg !208
  ret void, !dbg !208
}
...
if.end:                                           ; preds = %if.then, %if.start
  ...
  %self9 = load %struct.Server*, %struct.Server** %self1, align 8, !dbg !213
  %buf10 = getelementptr %struct.Server, %struct.Server* %self9, i32 0, i32 2, !dbg !213
  %DOT11 = load i8*, i8** %buf10, align 8, !dbg !213
  call void @bzero(i8* %DOT11, i64 1024), !dbg !213
  %self12 = load %struct.Server*, %struct.Server** %self1, align 8, !dbg !214
  %rbuf13 = getelementptr %struct.Server, %struct.Server* %self12, i32 0, i32 3, !dbg !214
  %DOT14 = load i8*, i8** %rbuf13, align 8, !dbg !214
  call void @bzero(i8* %DOT14, i64 1024), !dbg !214
  ret void, !dbg !214

if.then:                                          ; preds = %if.start
  call void @log(i8* getelementptr inbounds ([32 x i8], [32 x i8]* @STR18, i32 0, i32 0)), !dbg !215
  call void @exit(i32 1), !dbg !212
  br label %if.end, !dbg !212
}

define void @Server.set_reuse(%struct.Server* %self) !dbg !216 {
entry:
  %self1 = alloca %struct.Server*, align 8, !dbg !217
  %opt = alloca i8*, align 8, !dbg !217
  store %struct.Server* %self, %struct.Server** %self1, align 8, !dbg !217
  store i8* null, i8** %opt, align 8, !dbg !217
  %stack = alloca [4 x i8], align 1, !dbg !217
  %stack2 = getelementptr [4 x i8], [4 x i8]* %stack, i32 0, i32 0, !dbg !217
  store i8* %stack2, i8** %opt, align 8, !dbg !217
  %opt3 = load i8*, i8** %opt, align 8, !dbg !218
  %ACCESS = getelementptr i8, i8* %opt3, i32 0, !dbg !218
  store i8 1, i8* %ACCESS, align 1, !dbg !218
  %self4 = load %struct.Server*, %struct.Server** %self1, align 8, !dbg !219
  %fd = getelementptr %struct.Server, %struct.Server* %self4, i32 0, i32 0, !dbg !219
  %DOT = load i32, i32* %fd, align 4, !dbg !219
  %opt5 = load i8*, i8** %opt, align 8, !dbg !219
  %setsockopt = call i32 @setsockopt(i32 %DOT, i32 65535, i32 4, i8* %opt5, i32 4), !dbg !219
  %self6 = load %struct.Server*, %struct.Server** %self1, align 8, !dbg !220
  %fd7 = getelementptr %struct.Server, %struct.Server* %self6, i32 0, i32 0, !dbg !220
  %DOT8 = load i32, i32* %fd7, align 4, !dbg !220
  %opt9 = load i8*, i8** %opt, align 8, !dbg !220
  %setsockopt10 = call i32 @setsockopt(i32 %DOT8, i32 65535, i32 512, i8* %opt9, i32 4), !dbg !220
  ret void, !dbg !220
}

define void @Server.handle_client(%struct.Server* %self) !dbg !221 {
entry:
  %self1 = alloca %struct.Server*, align 8, !dbg !222
  %r = alloca i32, align 4, !dbg !222
  %pid2 = alloca i32, align 4, !dbg !222
  store %struct.Server* %self, %struct.Server** %self1, align 8, !dbg !222
  store i32 0, i32* %r, align 4, !dbg !222
  store i32 0, i32* %r, align 4, !dbg !222
  store i32 0, i32* %pid2, align 4, !dbg !222
  %fork = call i32 @fork(), !dbg !223
  store i32 %fork, i32* %pid2, align 4, !dbg !223
  br label %if.start, !dbg !223

if.start:                                         ; preds = %entry
  %pid22 = load i32, i32* %pid2, align 4, !dbg !223
  %EQ = icmp eq i32 %pid22, 0, !dbg !223
  br i1 %EQ, label %if.then, label %if.end, !dbg !223

if.end:                                           ; preds = %if.start
  call void @log(i8* getelementptr inbounds ([23 x i8], [23 x i8]* @STR26, i32 0, i32 0)), !dbg !224
  br label %while.start17, !dbg !224
...
while.then:                                       ; preds = %while.start
  %self3 = load %struct.Server*, %struct.Server** %self1, align 8, !dbg !225
  %client_fd = getelementptr %struct.Server, %struct.Server* %self3, i32 0, i32 1, !dbg !225
  %DOT = load i32, i32* %client_fd, align 4, !dbg !225
  %self4 = load %struct.Server*, %struct.Server** %self1, align 8, !dbg !225
  %buf = getelementptr %struct.Server, %struct.Server* %self4, i32 0, i32 2, !dbg !225
  %DOT5 = load i8*, i8** %buf, align 8, !dbg !225
  %read = call i32 @read(i32 %DOT, i8* %DOT5, i32 1023), !dbg !225
  store i32 %read, i32* %r, align 4, !dbg !225
  br label %if.start6, !dbg !225

while.end:                                        ; preds = %if.then8, %while.start
  ret void, !dbg !226

if.start6:                                        ; preds = %while.then
  %r9 = load i32, i32* %r, align 4, !dbg !225
  %LE = icmp sle i32 %r9, 0, !dbg !225
  br i1 %LE, label %if.then8, label %if.end7, !dbg !225

if.end7:                                          ; preds = %if.start6
  %self10 = load %struct.Server*, %struct.Server** %self1, align 8, !dbg !227
  %buf11 = getelementptr %struct.Server, %struct.Server* %self10, i32 0, i32 2, !dbg !227
  %DOT12 = load i8*, i8** %buf11, align 8, !dbg !227
  %r13 = load i32, i32* %r, align 4, !dbg !227
  %ACCESS = getelementptr i8, i8* %DOT12, i32 %r13, !dbg !227
  store i8 0, i8* %ACCESS, align 1, !dbg !227
  call void @log(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @STR22, i32 0, i32 0)), !dbg !228
  %self14 = load %struct.Server*, %struct.Server** %self1, align 8, !dbg !229
  %buf15 = getelementptr %struct.Server, %struct.Server* %self14, i32 0, i32 2, !dbg !229
  %DOT16 = load i8*, i8** %buf15, align 8, !dbg !229
  call void @log_ts(i8* getelementptr inbounds ([8 x i8], [8 x i8]* @STR23, i32 0, i32 0), i8* getelementptr inbounds ([9 x i8], [9 x i8]* @STR24, i32 0, i32 0), i8* %DOT16), !dbg !229
  call void @log(i8* getelementptr inbounds ([23 x i8], [23 x i8]* @STR25, i32 0, i32 0)), !dbg !226
  br label %while.start, !dbg !226

if.then8:                                         ; preds = %if.start6
  call void @log_ts(i8* getelementptr inbounds ([8 x i8], [8 x i8]* @STR19, i32 0, i32 0), i8* getelementptr inbounds ([9 x i8], [9 x i8]* @STR20, i32 0, i32 0), i8* getelementptr inbounds ([20 x i8], [20 x i8]* @STR21, i32 0, i32 0)), !dbg !230
  br label %while.end, !dbg !230

while.start17:                                    ; preds = %if.end24, %if.end
  br i1 true, label %while.then18, label %while.end19, !dbg !224

while.then18:                                     ; preds = %while.start17
  %self20 = load %struct.Server*, %struct.Server** %self1, align 8, !dbg !231
  %rbuf = getelementptr %struct.Server, %struct.Server* %self20, i32 0, i32 3, !dbg !231
  %DOT21 = load i8*, i8** %rbuf, align 8, !dbg !231
  %read22 = call i32 @read(i32 0, i8* %DOT21, i32 1023), !dbg !231
  store i32 %read22, i32* %r, align 4, !dbg !231
  br label %if.start23, !dbg !231

while.end19:                                      ; preds = %if.then25, %while.start17
  %self41 = load %struct.Server*, %struct.Server** %self1, align 8, !dbg !232
  %client_fd42 = getelementptr %struct.Server, %struct.Server* %self41, i32 0, i32 1, !dbg !232
  %DOT43 = load i32, i32* %client_fd42, align 4, !dbg !232
  %close = call i32 @close(i32 %DOT43), !dbg !232
  ret void, !dbg !232

if.start23:                                       ; preds = %while.then18
  %r26 = load i32, i32* %r, align 4, !dbg !231
  %LE27 = icmp sle i32 %r26, 0, !dbg !231
  br i1 %LE27, label %if.then25, label %if.end24, !dbg !231

if.end24:                                         ; preds = %if.start23
  %self28 = load %struct.Server*, %struct.Server** %self1, align 8, !dbg !233
  %rbuf29 = getelementptr %struct.Server, %struct.Server* %self28, i32 0, i32 3, !dbg !233
  %r30 = load i32, i32* %r, align 4, !dbg !233
  %SUB = sub i32 %r30, 1, !dbg !233
  %DOT31 = load i8*, i8** %rbuf29, align 8, !dbg !233
  %ACCESS32 = getelementptr i8, i8* %DOT31, i32 %SUB, !dbg !233
  store i8 0, i8* %ACCESS32, align 1, !dbg !233
  %self33 = load %struct.Server*, %struct.Server** %self1, align 8, !dbg !234
  %client_fd34 = getelementptr %struct.Server, %struct.Server* %self33, i32 0, i32 1, !dbg !234
  %DOT35 = load i32, i32* %client_fd34, align 4, !dbg !234
  %self36 = load %struct.Server*, %struct.Server** %self1, align 8, !dbg !234
  %rbuf37 = getelementptr %struct.Server, %struct.Server* %self36, i32 0, i32 3, !dbg !234
  %DOT38 = load i8*, i8** %rbuf37, align 8, !dbg !234
  %r39 = load i32, i32* %r, align 4, !dbg !234
  %SUB40 = sub i32 %r39, 1, !dbg !234
  %write = call i32 @write(i32 %DOT35, i8* %DOT38, i32 %SUB40), !dbg !234
  call void @log(i8* getelementptr inbounds ([23 x i8], [23 x i8]* @STR27, i32 0, i32 0)), !dbg !235
  br label %while.start17, !dbg !235

if.then25:                                        ; preds = %if.start23
  br label %while.end19, !dbg !231
}
...
!198 = !DILocation(line: 4, scope: !197)
!199 = !DILocation(line: 5, scope: !197)
!200 = !DILocation(line: 6, scope: !197)
!201 = !DILocation(line: 7, scope: !197)
!202 = !DILocation(line: 8, scope: !197)
!203 = !DILocation(line: 9, scope: !197)
!204 = !DILocation(line: 10, scope: !197)
!205 = !DILocation(line: 11, scope: !197)
!206 = !DILocation(line: 12, scope: !197)
!207 = !DILocation(line: 13, scope: !197)
...
!213 = !DILocation(line: 31, scope: !209)
!214 = !DILocation(line: 32, scope: !209)
!215 = !DILocation(line: 26, scope: !209)
!216 = distinct !DISubprogram(name: "Server.set_reuse", linkageName: "Server.set_reuse", scope: null, file: !3, line: 34, type: !5, scopeLine: 34, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !6)
!217 = !DILocation(line: 34, scope: !216)
!218 = !DILocation(line: 36, scope: !216)
!219 = !DILocation(line: 37, scope: !216)
!220 = !DILocation(line: 38, scope: !216)
!221 = distinct !DISubprogram(name: "Server.handle_client", linkageName: "Server.handle_client", scope: null, file: !3, line: 40, type: !5, scopeLine: 40, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !6)
!222 = !DILocation(line: 40, scope: !221)
!223 = !DILocation(line: 42, scope: !221)
!224 = !DILocation(line: 55, scope: !221)
!225 = !DILocation(line: 45, scope: !221)
!226 = !DILocation(line: 52, scope: !221)
!227 = !DILocation(line: 49, scope: !221)
!228 = !DILocation(line: 50, scope: !221)
!229 = !DILocation(line: 51, scope: !221)
!230 = !DILocation(line: 47, scope: !221)
!231 = !DILocation(line: 57, scope: !221)
!232 = !DILocation(line: 64, scope: !221)
!233 = !DILocation(line: 60, scope: !221)
!234 = !DILocation(line: 61, scope: !221)
!235 = !DILocation(line: 62, scope: !221)
